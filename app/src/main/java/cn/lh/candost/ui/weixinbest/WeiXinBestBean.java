...
public class WeiXinBestBean implements Parcelable {
    ...
    protected WeiXinBestBean(Parcel in) {
        totalPage = in.readInt();
        ps = in.readInt();
        pno = in.readInt();
    }

    public static final Creator<WeiXinBestBean> CREATOR = new Creator<WeiXinBestBean>() {
        @Override
        public WeiXinBestBean createFromParcel(Parcel in) {
            return new WeiXinBestBean(in);
        }

        @Override
        public WeiXinBestBean[] newArray(int size) {
            return new WeiXinBestBean[size];
        }
    };
